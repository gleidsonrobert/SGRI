...
<div class="conteudo_esquerda">
	...
	<a class="botao" href="cadastrar_reserva_aula.php">
	...
	<div class="conteudo_direita">
		<div class="bloco_busca">
			<div class="bloco_busca_content">
				<span class="titulo">Disciplina</span>
				<input type="text"
					   id="disciplinaTurma"
				...
				/>
				<br><br>
				<span class="titulo">Data Aula</span>
				<input type="text"
					   id="dataAula"
					   name="dataAula"
					   maxlength="8"
		...
		<div id="pagina">
			<?php include_once("../control/ReservaControle.php"); $reservaControle->listarReservasAula(); ?>
		</div>
	</div>
</form>
...
<script>
	function pesquisa()
	{
		...
		url="../control/ReservaControle.php?disciplinaTurma="+disciplinaTurma+"&dataAula="+dataAula+"&opcaoReserva=ListarReservasAula";
		ajax(url);
	}
</script>