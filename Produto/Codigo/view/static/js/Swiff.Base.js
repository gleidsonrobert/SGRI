...
var Swiff = function(source, props){
	...
	// para retirar o cacheamento do IE
	swf = swf + '&rand=' + Math.random();
/*
...
*/	
	return new Element('div').setHTML(
		'<object style="position: absolute;top: -0px; left: 0px; z-index: 1000" width="', 100, '" height="', 20, '" id="', props.id, '" type="application/x-shockwave-flash" data="', swf, '">'
			,'<param name="allowScriptAccess" value="', props.allowScriptAccess, '" />'
			,'<param name="movie" value="', swf, '" />'
			,'<param name="bgcolor" value="', props.bgcolor, '" />'
			,'<param name="scale" value="noscale" />'
